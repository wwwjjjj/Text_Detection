...
def visualize_detection(image, contours, tr=None, hm=None,hm_t=None,hm_b=None,hm_l=None,hm_r=None):
    ...
    image_show = cv2.polylines(image_show, contours, True, (0, 0, 255), 2)
...
def inference(cfg,detector, test_loader, output_dir,exp_name):
...
def main(opt,cfg,model,test_loader):
    ...
    total_time=inference(cfg,detector, test_loader, output_dir,opt.exp_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_name", type=str, default="Hourglass_10_30")
